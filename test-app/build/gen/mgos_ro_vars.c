 ...
 * Command: /mongoose-os/tools/mgos_gen_config.py --c_name=mgos_ro_vars --c_global_name=mgos_sys_ro_vars --dest_dir=/data/fwbuild-volumes/2.19.1/apps/test-app/esp32/build_contexts/build_ctx_644048620/build/gen/ /mongoose-os/src/mgos_ro_vars_schema.yaml
 */
